...
6 REM
7 REM Adapted for NASCOM Basic 2023 Kian Ryan
8 REM
9 REM
...
REM IS THIS LINE TOO LONG FOR PASTE?
...
2680 LET F=F+52+RND(1)*6
2690 LET B=B-10-RND(1)*4
2700 GOTO 2720
...
3760 LET M=M-5-4*RND(1)
3770 LET M1=M1-2-3*RND(1)
3780 GOTO 4710
...
4570 LET M=M-5-RND(1)*10
4580 LET B=B-200
4590 LET M1=M1-4-RND(1)*3
4600 GOTO 4710
...
4800 LET M1=M1-5
4810 LET B=B-200
4820 LET M=M-20-30*RND(1)
4830 GOTO 4860
4840 PRINT "THE GOING GETS SLOW"
4850 LET M=M-45-RND(1)/.02
...
5280 PRINT "BUT YOUR AUNT SADIE IN ST. LOUIS IS REALLY WORRIED ";
5285 PRINT "ABOUT YOU"
8290 PRINT
8300 GOTO 5330
